...
class Mainwindow(QMainWindow):
    ...
    def openfolder(self):
        self.directory = QFileDialog.getExistingDirectory(self,"Choose NeuralSight Folder",r"C:\Users\Administrator\Desktop\\")
    ...
    def close_confirm(self):
        reply = QMessageBox.question(self, 'Exit', 'Are you sure to quit？', QMessageBox.Yes | QMessageBox.Cancel, QMessageBox.Cancel)
        if reply == QMessageBox.Yes:
            self.close()

    def about(self):
        QMessageBox.about(self, 'About', '''Our Mission is To positively impact healthcare by using Artificial Intelligence (AI), to democratize access to diagnostic healthcare.

All Rights Reserved. 
Copyright NeuralSight ©2021''')
